...
class InstructPix2Pix(nn.Module):
    ...
    def edit_image(
        ...
        # self.visualize_image(img_mask) # check the bg mask if you wish
        # exit()
        ...
        # self.visualize_image(image_cond)
        # add noise
        ...
        # self.visualize_image(decoded_img) # check the edited image if you wish
